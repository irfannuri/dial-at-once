...
namespace Xamarin3United.PCL
{
	...
	{
		private List<KeyValuePair<string, Person>> dictionary = new List<KeyValuePair<string, Person>>();

		/// <summary>
		/// Gets or sets the words dictionary.
		/// </summary>
		public List<KeyValuePair<string, Person>> Dictionary
		{
			get
			{
		...
		/// </summary>
		public List<Person> DecodeString(string t9Text)
		{
		...
		/// </summary>
		public List<Person> Predict(string prefix)
		{
			return (from w in this.dictionary
		...
		{
			string normalizedText = clearText;
